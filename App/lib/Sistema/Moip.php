...
class Sistema_Moip
{
    private $auth = "MOBZRG31J17GMZJMZQWBKYZIR7WGXD0O:UHL4IAQV4OTG8X7LDMMDLXRQ9FMXOLPARDWOJMWM";
	...
	public function Debito($banco)
	{
        ...
        <EnviarInstrucao>
            <InstrucaoUnica>
                <Razao>$produtonome - Check busca - ".$this->getCodigo()."|".rand(111111,999999)."</Razao>
	...
	public function gerar()
	{
        ...
        <EnviarInstrucao>
            <InstrucaoUnica>
				...
				<URLNotificacao>http://checkbusca.com/nasp.php</URLNotificacao>
				<URLRetorno>http://checkbusca.com/nasp.php</URLRetorno>
                <Recebedor>
                    <LoginMoIP>sistemas21</LoginMoIP>
                    <Apelido>Check busca</Apelido>
                </Recebedor>
