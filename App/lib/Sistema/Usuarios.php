    ...
    public function getRes($id=null)
    {
        if(!$this->getDb()){
            ...
            return [
                ...
                'id_usuario' => '1426',
                'usuario'=> 'putty',
                'servicos' => 'MultiCredito,Buscaempresa,Consultadecredito,ConsultaMaxGold,Bacen,busca,Checkespecial,buscaGold,Megabusca,Natt2,BuscaMix,LocalizaRG,CheckFone,ConsultaCadastral,ConsultaDoc,Masterbusca,Consultapai,ConsultaCondutor,checkpai,consultacondutor2,CheckRg,MaxVeiculos,Spc,Fipe,Hiscon,extratodepagamentosinss,Previdencia-social,Aps,cartainss,Tempo,descontos,Declarar-imposto,Cons-process-juridicos,Consultar-operadora,listatelefone,fgts,cheques,Antecedentes-criminais,Consultar-Obito,Ache-cep,digitorg,hotel,GoogleEarth,Sms,Justica-eleitoral,Ache-certo,Controle,sixbusca,mapas,Processual,Qnumero,Receita-juridica,Receita-fisica,planoss,Relato,CheckInss,Navegadores,Regras,Bloqueado1,Bloqueado2,Bloqueado3,Bloqueado4,Intouch,UpBusca,Check-ok,Original,Zipcode,ZipOn,Extrato,Checkcondutor,Checkveiculos,max-spc-serasa',
                'status' => true
            ];
        }
